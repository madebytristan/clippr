    ...
    <div className="flex min-h-screen" style={{ backgroundColor: "#0d0d14" }}>
      ...
      <aside className="shrink-0 w-14 flex flex-col items-center py-4 border-r border-surface-border gap-6">
        ...
        <div className="flex flex-col items-center gap-2">
          {CLERK_CONFIGURED ? (
            ...
            <Link href="#" title="Settings" className="w-9 h-9 rounded-lg flex items-center justify-center text-gray-500 hover:text-gray-300 hover:bg-surface-hover">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="flex items-center justify-end gap-3 px-6 py-3 border-b border-surface-border shrink-0">
          ...
          {/* Auth area — Clerk when configured, static fallback otherwise */}
          {CLERK_CONFIGURED ? (
            <ClerkTopbarButtons />
          ) : (
            <div className="flex items-center gap-2">
              <Link
                href="/sign-in"
                className="px-3 py-1.5 rounded-lg border border-surface-border text-sm text-gray-300 hover:border-accent/50 hover:text-white font-medium transition-colors"
              >
                Log In
              </Link>
              <Link
